...
namespace Lab09_Entity_Framework.Models
{
    public class RestaurantContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Định nghĩa mối quan hệ một-nhiều giữa Table và Bills
            ...
            // Định nghĩa mối quan hệ một-nhiều giữa Bills và BillDetails
            ...
            // Định nghĩa mối quan hệ một-nhiều giữa Food và BillDetails
            modelBuilder.Entity<BillDetails>()
